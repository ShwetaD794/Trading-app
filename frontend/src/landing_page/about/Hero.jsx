...
export default function Hero(){
    return(
        <div className="container">
            <div className="row">
                <h3 className='about-info'>We pioneered the discount broking model in India.
                    <br></br>
            ...
            <div className="row about-details">
                ...
                <div className="col-6">
                    ...
                    <p>
                    And yet, we are always up to something new every day. Catch up on the latest updates on our <a href=''>blog</a> or see what the media is <a href=''>saying about us</a> or learn more about our business and product <a href=''>philosophies</a>.</p>
                </div>
            </div>
        </div>
    )
